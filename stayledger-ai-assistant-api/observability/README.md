...
- PrometheusRules: [prometheus-rules.yaml](prometheus-rules.yaml), [prometheus-recording-rules.yaml](prometheus-recording-rules.yaml), [prometheus-infrastructure-alerts.yaml](prometheus-infrastructure-alerts.yaml), [stayledger-ai-assistant-alerts.yaml](stayledger-ai-assistant-alerts.yaml), [metrics-pipeline-alerts.yaml](metrics-pipeline-alerts.yaml), [datastore-exporter-alerts.yaml](datastore-exporter-alerts.yaml), [rag-eval-alerts.yaml](alerts/rag-eval-alerts.yaml), [kb-embedding-backlog-alerts.yaml](alerts/kb-embedding-backlog-alerts.yaml), [llm-cost-alerts.yaml](alerts/llm-cost-alerts.yaml)
